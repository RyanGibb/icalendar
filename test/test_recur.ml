...
UID:TU1831481901
DTSTAMP:20250221T173943Z
SUMMARY:event (Updated Time)
CATEGORIES:Calendar 1
CLASS:PUBLIC
TRANSP:OPAQUE
SEQUENCE:1
DTSTART;TZID=Europe/Paris:20250226T183000
DTEND;TZID=Europe/Paris:20250226T193000
RECURRENCE-ID;TZID=Europe/Paris:20250226T063000
CREATED:20250221T173553Z
END:VEVENT
BEGIN:VEVENT
UID:TU1831481901
...
RECURRENCE-ID;TZID=Europe/Paris:20250227T063000
DTSTART;TZID=Europe/Paris:20250227T063000
STATUS:CANCELLED
END:VEVENT
END:VCALENDAR|}
...
let ex_recurrence_id () =
  ...
  let event, recurrence_ids =
    match List.partition (function `Event _ -> true | _ -> false) (snd calendar) with
    | `Event hd :: tl, _ -> hd, List.map (function `Event e -> e | _ -> assert false) tl
    | _ -> assert false
  in
  ...
  - the event on february 26 is updated to 18:30.
  - the event on february 27 is cancelled. *)
  Alcotest.(check (string) "compute occurences example 39"
              {|`With_tzid ((2025-02-16 06:30:00 +00:00, (false, "Europe/Paris")))
`With_tzid ((2025-02-17 06:30:00 +00:00, (false, "Europe/Paris")))
`With_tzid ((2025-02-18 06:30:00 +00:00, (false, "Europe/Paris")))
`With_tzid ((2025-02-19 06:30:00 +00:00, (false, "Europe/Paris")))
...
`With_tzid ((2025-02-24 06:30:00 +00:00, (false, "Europe/Paris")))
`With_tzid ((2025-02-25 06:30:00 +00:00, (false, "Europe/Paris")))
`With_tzid ((2025-02-26 18:30:00 +00:00, (false, "Europe/Paris")))
`With_tzid ((2025-02-28 06:30:00 +00:00, (false, "Europe/Paris")))
`With_tzid ((2025-03-01 06:30:00 +00:00, (false, "Europe/Paris")))
`With_tzid ((2025-03-02 06:30:00 +00:00, (false, "Europe/Paris")))
`With_tzid ((2025-03-03 06:30:00 +00:00, (false, "Europe/Paris")))
